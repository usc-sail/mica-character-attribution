"""Prompt Gemini on the test dataset for character attribution using character segments"""
import pandas as pd
import time
import tqdm
import os
...
flags.DEFINE_string("prompttemplatefile", default="50-prompting/prompt-templates/gemini-segment-attribution.txt",
...
flags.DEFINE_string("outputresponsefile", default="50-prompting/prompt-responses/gemini-segment-attribution.csv",
    ...
    if run:
        ...
        for prompt in tqdm.tqdm(prompt_df["prompt"], desc="prompting", unit="prompt"):
            if prompt:
                ...
                responses = ["ERROR: empty segments" for _ in range(ncandidates)]
