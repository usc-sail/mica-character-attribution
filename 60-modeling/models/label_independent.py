...
class LabelIndependent(nn.Module):
    ...
    def __init__(self, pretrained_model_name, *args, **kwargs) -> None:
        ...
        self.name_token_weights = nn.Linear(self.hidden_size, 1)
        self.name_weights = nn.Linear(self.hidden_size, 1)
        self.mention_token_weights = nn.Linear(self.hidden_size, 1)
        self.mention_weights = nn.Linear(self.hidden_size, 1)
